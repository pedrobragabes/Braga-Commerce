    ...
    <section className="order-success-page">
      <div className="store-container order-success-grid">
          ...
          <div className="success-actions">
            {phone ? (
              <a
                ...
                target="_blank"
              >
                <StoreIcon name="whatsapp" /> Falar sobre o pedido
              </a>
            ) : null}
        ...
        <aside className="order-receipt">
          ...
          <div className="summary-row">
            <span>{order.deliveryMethod === "LOCAL_PICKUP" ? "Retirada" : "Entrega"}</span>
            <strong>{order.shippingCents ? formatCurrency(order.shippingCents) : "Grátis"}</strong>
          </div>
          ...
          <p className="receipt-status">
            <span /> {order.paymentStatus === "PAID" ? "Pagamento confirmado" : "Pedido salvo"}
          </p>
        </aside>
      </div>
    </section>
