# Handoff — M4 Admin MVP em andamento
...
1. Completar login pelo formulário e confirmar cookie/redirecionamento.
...
7. Corrigir qualquer falha encontrada, repetir testes e build.
8. Publicar a versão final, validar Vercel e só então comentar/fechar issues #20–#29.
